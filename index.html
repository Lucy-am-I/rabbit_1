...
<html lang="en-us">
  <head>
    ...
    <title>Unity Web Player | usausa_pazle</title>
  ...
  <body>
    <div id="unity-container" class="unity-desktop">
      ...
      <div id="unity-footer">
        ...
        <div id="unity-build-title">usausa_pazle</div>
      </div>
    </div>
    <script>
      ...
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/完成ゲーム１.loader.js";
      var config = {
        arguments: [],
        dataUrl: buildUrl + "/完成ゲーム１.data",
        frameworkUrl: buildUrl + "/完成ゲーム１.framework.js",
        codeUrl: buildUrl + "/完成ゲーム１.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "usausa_pazle",
        productVersion: "1.0",
